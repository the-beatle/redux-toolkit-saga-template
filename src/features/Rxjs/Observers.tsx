  ...
  return (
    <div>
      <header>
        ...
        <p><strong>Observers</strong> are just objects with three callbacks, one for each type of notification that an Observable may deliver.</p>
        <ul>
        <li>Next</li>
        <li>error</li>
        <li>complete</li>
        ...
        <code>{"observable.subscribe(x => console.log('Observer got a next value: ' + x));"}</code>
